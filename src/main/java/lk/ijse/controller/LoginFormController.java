...
public class LoginFormController {
    ...
    public void btnUserLoginOnAction(ActionEvent actionEvent) {
        ...
        try {
            anchorPane = FXMLLoader.load(getClass().getResource("/view/User/User_login_form.fxml"));
    ...
    public void btnAdminLoginOnAction(ActionEvent actionEvent) {
        AnchorPane anchorPane = null;
        try {
            anchorPane = FXMLLoader.load(getClass().getResource("/view/Admin/Admin_login_form.fxml"));
            Scene scene = new Scene(anchorPane);
            Stage stage = (Stage) root.getScene().getWindow();
            stage.setScene(scene);
            stage.centerOnScreen();
