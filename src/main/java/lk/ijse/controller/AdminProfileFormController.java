...
public class AdminProfileFormController {
    ...
    void btnAddAdminOnAction(ActionEvent event) {
        Parent fxml = null;
        try {
            fxml = FXMLLoader.load(getClass().getResource("/view/Admin/Add_new_admin_form.fxml"));
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == yesButton) {
            try {
                ...
                try {
                    stage.setScene(new Scene(FXMLLoader.load(getClass().getResource("/view/Admin/Admin_login_form.fxml")))); // Load and set the scene for login form
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
