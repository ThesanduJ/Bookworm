...
public class UserDashboardFormController {
    ...
    void btnBorrowOnAction(ActionEvent event) {
        ...
        Parent fxml = null;
        try {
            fxml = FXMLLoader.load(getClass().getResource("/view/User/Borrow_book_form.fxml"));
    ...
    void btnDashboardOnAction(ActionEvent event) {
        ...
        try {
            anchorPane = FXMLLoader.load(getClass().getResource("/view/User/User_dashboard_form.fxml"));
    ...
    void btnHistoryOnAction(ActionEvent event) {
        Parent fxml = null;
        try {
            fxml = FXMLLoader.load(getClass().getResource("/view/User/User_history_form.fxml"));
            pane2.getChildren().removeAll();
    ...
    void btnLibraryOnAction(ActionEvent event) {
        Parent fxml = null;
        try {
            fxml = FXMLLoader.load(getClass().getResource("/view/User/My_library_form.fxml"));
            pane2.getChildren().removeAll();
    ...
    void imgUserNameOnAction(MouseEvent event) {
        Parent fxml = null;
        try {
            fxml = FXMLLoader.load(getClass().getResource("/view/User/User_profile_form.fxml"));
            pane2.getChildren().removeAll();
    ...
    void txtSearchOnAction(ActionEvent event) {
        ...
        try {
            ...
            if (dto!=null){
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/User/Book_popup_form.fxml"));
